...
class Model:
    ...
    def __getattr__(self, key):
        ...
        if key in self._descriptors and key not in self.__dict__ and isinstance(self._descriptors[key], ProtectedList):
            self.__dict__[key] = self._descriptors[key].copy()
    ...
    def __setattr__(self, key, value):
        ...
        if isinstance(self._descriptors[key], ProtectedList):
